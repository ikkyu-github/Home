// SafariLikeCoreKit/ChromePolicy.swift
// Source of truth for Chrome UI policies

import Foundation
import CoreGraphics

/// Threading: ChromePolicy describes UI chrome configuration
/// and is expected to be created and used on the main actor.
@MainActor
